...
tempData <- read.table(file = "Data/Ross T1_SoilData.dat", header = FALSE, sep = ",", fill = TRUE)
...
# Create new data frames using the column indices
...
# to exclude rows with all being zeros
#VWC <- VWC[!apply(VWC == 0, 1, all), ]
VWC <- VWC[!apply(VWC[, 2:7] == 0, 1, all), ]
...
write.table(VWC, file = "Output/VWC1.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
#EC <- EC[!apply(EC == 0, 1, all), ]
EC <- EC[!apply(EC[, 2:7] == 0, 1, all), ]
...
write.table(EC, file = "Output/EC1.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
# to exclude rows with any zeros
#Temp <- Temp[!apply(Temp == 0, 1, all), ]
Temp <- Temp[!apply(Temp[, 2:7] == 0, 1, all), ]
...
write.table(Temp, file = "Output/Temp1.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
SV_VWC <- SV_VWC[!apply(SV_VWC[, 2:7] == 0, 1, all), ]
...
write.table(SV_VWC, file = "Output/SV_VWC1.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_VWC[, 1], SV_VWC[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_VWC Over Time', ylim = c(0.00, 0.45))
...
# List of column names from the 2nd to the 10th
...
SV_EC <- SV_EC[!apply(SV_EC[, 2:7] == 0, 1, all), ]
...
write.table(SV_EC, file = "output/SV_EC1.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_EC[, 1], SV_EC[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_EC Over Time', ylim = c(0.00, 0.45))
...
SV_Temp <- SV_Temp[!apply(SV_Temp[, 2:7] == 0, 1, all), ]
...
write.table(SV_Temp, file = "Output/SV_Temp1.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_Temp[, 1], SV_Temp[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_Temp Over Time', ylim = c(17, 27))
...
tempData2 <- read.table(file = "Data/Ross T2_SoilData.dat", header = FALSE, sep = ",", fill = TRUE)
...
VWC2 <- VWC2[!apply(VWC2[, 2:7] == 0, 1, all), ]
...
write.table(VWC2, file = "Output/VWC2.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
write.table(EC2, file = "Output/EC2.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Temp2 <- Temp2[!apply(Temp2[, 2:7] == 0, 1, all), ]
...
write.table(Temp2, file = "Output/Temp2.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(Temp2[, 1], Temp2[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'Temperature2 Over Time', ylim = c(21, 30))
...
SV_VWC2 <- SV_VWC2[!apply(SV_VWC2[, 2:7] == 0, 1, all), ]
...
write.table(SV_VWC2, file = "Output/SV_VWC2.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_VWC2[, 1], SV_VWC2[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_VWC2 Over Time', ylim = c(0.00, 0.45))
...
SV_EC2 <- SV_EC2[!apply(SV_EC2[, 2:7] == 0, 1, all), ]
...
write.table(SV_EC2, file = "Output/SV_EC2.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_EC2[, 1], SV_EC2[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_EC2 Over Time', ylim = c(0.00, 0.40))
...
SV_Temp2 <- SV_Temp2[!apply(SV_Temp2[, 2:7] == 0, 1, all), ]
...
write.table(SV_Temp2, file = "Output/SV_Temp2.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
#Choose your desired y-axis limits (and change it manually in line below).
y_min <- min(c(SV_Temp2[, 2], SV_Temp2[, 3], SV_Temp2[, 4], SV_Temp2[, 5], SV_Temp2[, 6], SV_Temp2[, 7], SV_Temp2[, 8], SV_Temp2[, 9], SV_Temp2[, 10]), na.rm = TRUE)
y_max <- max(c(SV_Temp2[, 2], SV_Temp2[, 3], SV_Temp2[, 4], SV_Temp2[, 5], SV_Temp2[, 6], SV_Temp2[, 7], SV_Temp2[, 8], SV_Temp2[, 9], SV_Temp2[, 10]), na.rm = TRUE)

# Create a plot with timestamp on the x-axis
plot(SV_Temp2[, 1], SV_Temp2[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_Temp2 Over Time', ylim = c(14, 32))
...
tempData3 <- read.table(file = "Data/Ross T3_SoilData.dat", header = FALSE, sep = ",", fill = TRUE)
...
VWC3 <- VWC3[!apply(VWC3[, 2:7] == 0, 1, all), ]
...
write.table(VWC3, file = "Output/VWC3.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
write.table(EC3, file = "Output/EC3.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Temp3 <- Temp3[!apply(Temp3[, 2:7] == 0, 1, all), ]
...
write.table(Temp3, file = "Output/Temp3.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
SV_VWC3 <- SV_VWC3[!apply(SV_VWC3[, 2:7] == 0, 1, all), ]
...
write.table(SV_VWC3, file = "Output/SV_VWC3.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_VWC3[, 1], SV_VWC3[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_VWC3 Over Time', ylim = c(-0.0, 0.80))
...
# Add a legend to distinguish the different lines
legend("topright", legend = c("SV_VWC3 5cm", "SV_VWC3 10cm", "SV_VWC3 20cm", "SV_VWC3 30cm", "SV_VWC3 40cm", "SV_VWC3 50cm", "SV_VWC3 60cm", "SV_VWC3 75cm", "SV_VWC3 100cm"),
       col = c('red', 'blue', 'green', 'purple', 'orange', 'yellow', 'brown', 'lightblue', 'lightgreen'), lty = 1, cex = 0.8)
...
SV_EC3 <- SV_EC3[!apply(SV_EC3[, 2:7] == 0, 1, all), ]
...
write.table(SV_EC3, file = "Output/SV_EC3.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_EC3[, 1], SV_EC3[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_EC3 Over Time', ylim = c(0.00, 0.50))
...
SV_Temp3 <- SV_Temp3[!apply(SV_Temp3[, 2:7] == 0, 1, all), ]
...
write.table(SV_Temp3, file = "Output/SV_Temp3.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
plot(SV_Temp3[, 1], SV_Temp3[, 2], type = 'l', col = 'red', xlab = 'Timestamp', ylab = 'Values',
     main = 'SV_Temp3 Over Time', ylim = c(16.00, 30.00))
...
tempData_L1 <- read.table(file = "Data/Ross T1_LysimeterData.dat", header = FALSE, sep = ",", fill = TRUE)
...
Lys_mod_depth <- Lys_mod_depth[!apply(Lys_mod_depth[, 2:7] == 0, 1, all), ]
...
write.table(Lys_mod_depth, file = "Output/Lys1_mod_depth.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Lys_Temp <- Lys_Temp[!apply(Lys_Temp[, 2:7] == 0, 1, all), ]
...
write.table(Lys_Temp, file = "Output/Lys1_Temp.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Lys_EC <- Lys_EC[!apply(Lys_EC[, 2:7] == 0, 1, all), ]
...
write.table(Lys_EC, file = "Output/Lys1_EC.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
tempData_L2 <- read.table(file = "Data/Ross T2_LysimeterData.dat", header = FALSE, sep = ",", fill = TRUE)
...
Lys2_mod_depth <- Lys2_mod_depth[!apply(Lys2_mod_depth[, 2:7] == 0, 1, all), ]
...
write.table(Lys2_mod_depth, file = "Output/Lys2_mod_depth.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Lys2_Temp <- Lys2_Temp[!apply(Lys2_Temp[, 2:7] == 0, 1, all), ]
...
write.table(Lys2_Temp, file = "Output/Lys2_Temp.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Lys2_EC <- Lys2_EC[!apply(Lys2_EC[, 2:7] == 0, 1, all), ]
...
write.table(Lys2_EC, file = "Output/Lys2_EC.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
tempData_L3 <- read.table(file = "Data/Ross T3_LysimeterData.dat", header = FALSE, sep = ",", fill = TRUE)
...
Lys3_mod_depth <- Lys3_mod_depth[!apply(Lys3_mod_depth[, 2:7] == 0, 1, all), ]
...
write.table(Lys3_mod_depth, file = "Output/Lys3_mod_depth.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Lys3_Temp <- Lys3_Temp[!apply(Lys3_Temp[, 2:7] == 0, 1, all), ]
...
write.table(Lys3_Temp, file = "Output/Lys3_Temp.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
...
Lys3_EC <- Lys3_EC[!apply(Lys3_EC[, 2:7] == 0, 1, all), ]
...
write.table(Lys3_EC, file = "Output/Lys3_EC.dat", sep = "\t", row.names = FALSE, col.names = TRUE)
